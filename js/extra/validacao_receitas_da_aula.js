...
$("#btnAddReceita").click(function(event) {
  ...
  var htmlTdNome = $('<td class="info-nome"><input hidden class="eachReceitaAula" type="text" name="receitaId" value="' + receita.id + '" /><p>' + receita.nome + '</p></td>');
  var htmlTdQtd = $('<td class="info-quantidade"><input hidden class="eachQuantidadeReceita" type="text" name="quantidade_receita]" value="' + receita.quantidade + '" /><p>' + receita.quantidade + '</p></td>');
